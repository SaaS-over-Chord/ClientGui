...
/**
 * The socket server of ClientGui.
 * This sever is designed to handle the migration request
 * from other <code>JavaPM</code>. It implements
 ...
 * @see java.net.Socket
 * @see clientgui.ClientGui
 */
public class ClientGuiProcessServer implements Runnable{
    /**
    ...
    private void accept(){
        ...
        new Thread(new ClientGuiProcessReceiver(clientSocket)).start();
    }
}
